...
// Lucide icons are not used directly in this wrapper anymore.
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[75vh] md:min-h-screen w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0d0d0d] via-transparent to-[#0d0d0d]/80 pointer-events-none" />
        </div>
    );
}
